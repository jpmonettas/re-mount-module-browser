(defproject re-mount-module-browser "0.1.0-SNAPSHOT"
  ...
  :figwheel {:css-dirs ["resources/public/css"]
             :ring-handler re-mount-module-browser.handler/dev-handler}
  ...
  {:builds
   [{:id           "dev"
     ...
     :figwheel     {:on-jsload "re-mount-module-browser.core/mount-root"}
  ...
  :main re-mount-module-browser.server

  :aot [re-mount-module-browser.server]

  :uberjar-name "re-mount-module-browser.jar"
